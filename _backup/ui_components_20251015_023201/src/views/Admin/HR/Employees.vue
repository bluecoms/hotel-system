  ...
  <v-container fluid class="page-shell py-6">
    ...
    <SmartFilterBar class="mb-4 brand-panel">
      <template #filters>
        ...
        <v-btn variant="outlined" color="grey" class="btn-action" :disabled="loading" @click="resetFilters">
          초기화
        </v-btn>
      </template>
    </SmartFilterBar>
...
import DialogEmployeeForm from '@/ui/components/DialogEmployeeForm.vue'
