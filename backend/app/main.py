...
# ============================================================================
# File      : app/main.py
# Version   : 2025.10-31 · v3.2 (Router Dump Filter · SSOT Final Stable)
...
# ----------------------------------------------------------------------------
# 개선 사항 (v3.2)
#   ✅ /api/me 라우트 문자열 완전 필터링 (Phase 3 이후 폐기)
#   ✅ OTA 관련 경로 요약 안정화
# ============================================================================
import logging
import warnings
...
ROUTERS_DEBUG = os.getenv("ROUTERS_DEBUG", "1") == "1"
ROUTERS_DUMP = os.getenv("ROUTERS_DUMP", "1") == "1"
